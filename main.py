...
def merge_hmms(input_dir, backbone_alignment, query_sequence_file, output_prefix, input_type, num_processes, support_value, equal_probabilities, model, output_format, debug, verbose):
    ...
    if(verbose):
        VERBOSE = True
    merge_hmms_helper(input_dir, backbone_alignment, query_sequence_file, output_prefix, input_type, num_processes, support_value, model, output_format, equal_probabilities)
